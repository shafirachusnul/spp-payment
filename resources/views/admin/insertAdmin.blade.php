...
@section('title','Insert Admin | Headmaster')
      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <form method="POST" action="{{route('admin.handleInsertAdmin')}}" class="card-body p-5 text-center">
              @csrf
              ...
              <p class="" style="color: #393f81;">Cancel Insertion? <a href="{{route('admin.adminList')}}" style="color: #508bfc;">Back to admin list page</a></p>
